...
function statistics(){
	...
	if($("#prodKeyword").val() == ''){
		...
		$.ajax({
			...
			type : 'post',
			dataType : 'text',
			data : {category_2nd : $("#category_2nd").val(),
		...
		$.ajax({
			url : '/statistics/getImportStatistics',
			type : 'post',
			dataType : 'text',
			data : {category_2nd : $("#category_2nd").val(),
					selectDate1 : $("#selectDate1").val(), selectDate2 : $("#selectDate2").val(),
...
<div class='col-md-2 col-xs-2' style="display: inline-block; margin-right: 5px; padding: 0;">
...
<a>~</a>
<div class='col-md-2 col-xs-2' style="display: inline-block; margin-right: 25px; padding: 0;">
    <div class="form-group">
